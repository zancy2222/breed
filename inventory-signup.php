<?php
        ...
        if(isset($_POST['save']))
        {
            ...
            header("location:inventory-log.php");
            $stmt = $conn->prepare("INSERT INTO db_signup (user_username, user_email, password) VALUES (?, ?, ?)");
  ...
  <body>
    <nav>
      ...
      <ul>
        ...
        <li><a class="active" href="shop-log.html">Login</a></li>
      </ul>
    </nav>
    ...
    <div class="wrapper">
        ...
        <h2 style="margin-top: 80px;">Admin Signup</h2>
        <form method="POST">
            <div class="input-box">
                <span class="icon"><ion-icon name="person"></ion-icon></span>
                <input type="text" placeholder="Username" name="user_username" required>
            </div>
            <div class="input-box">
            ...
            <div class="login-register">
                <p>You have an account? <a href="inventory-log.php" class="register-link">Login</a></p>
            </div>
        </form>
        </div>
    </div>
