<?php
        ...
        if(isset($_POST['save']))
        {
            ...
            $sql = "SELECT user_id, user_email, password From db_signup where user_email =?";
            ...
            if ($result->num_rows == 1)
            {
                ...
                {
                    echo 'incorrect password. <a href="inventory-log.php">Try Again!';
                }
            }
            else
            {
                echo 'email not found. <a href="inventory-log.php">Try Again!';
            }
            $stmt->close();
            $conn->close();
        }
  ...
  <body>
    ...
    <div class="wrapper">
        <div class="form-box login">
            <ul class="list">
                <li><a href="shop-log.php">SHOP</a></li>
                <li><a href="inventory-log.php" class="active">Admin</a></li>
            </ul>
        <h2 style="margin-top: 80px;">Admin Login</h2>
        <form method="POST">
            <div class="input-box">
            ...
            <button type="submit" class="btn" name="save">Login</button><hr>
            <div class="login-register">
            <button class="btn-create" ><a href="inventory-signup.php" class="register-link" style="color: white">Create Account</a></button>
            </div>
        </form>
        </div>
    </div>
