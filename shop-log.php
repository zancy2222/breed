<?php
        ...
        if(isset($_POST['save']))
        {
            ...
            if ($result->num_rows == 1)
            {
                ...
                {
                    echo 'incorrect password. <a href="shop-log.php">Try Again!';
                }
            }
            else
            {
                echo 'email not found. <a href="shop-log.php">Try Again!';
            }
            $stmt->close();
            $conn->close();
        }
...
<html lang="en" dir="ltr">
  ...
  <body>
    ...
    <div class="wrapper">
        ...
        <h2 style="margin-top: 80px;">Shop Login</h2>
        <form method="POST">
            <div class="input-box">
            ...
            <div class="login-register">
                <button class="btn-create" ><a href="shop-signup.php" class="register-link" style="color: white">Create Account</a></button>
            </div>
        </form>
        </div>
    </div>
